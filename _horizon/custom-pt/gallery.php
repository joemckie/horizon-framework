<?php
	...
	*/
	...
	add_action( 'horizon_add_meta_boxes', 'horizon_add_gallery_options' );
	function horizon_add_gallery_options(){
		horizon_add_meta_box( 'custom_meta_boxes', __('Gallery Options'), 'horizon_build_gallery_options', 'gallery', 'normal', 'high' );
	}
