<?php
	...
	*/
	...
	add_action( 'horizon_add_meta_boxes', 'horizon_add_page_options' );
	function horizon_add_page_options(){
		horizon_add_meta_box( 'custom_meta_boxes', __('Page Options'), 'horizon_build_page_options', 'page', 'normal', 'high' );
	}
