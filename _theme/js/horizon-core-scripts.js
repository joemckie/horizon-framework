...
function sidebar_height(){
	$(".horizon_sidebar_wrapper").css({
		"min-height": function() {return $(".horizon_page_item").height();}
	});
}
...
function horizon_init() {
	...
	$(".flexslider.flexslider-slide").flexslider({
		animation: "slide",
		start: function(){return flexslider_start();},
		pauseOnHover: true
	});
	...
	$(".horizon-shortcode-button").hover(function(){
		...
		$(this).css({
			"background-color": function(){return $(this).attr("data-hoverbg");},
			"color": function(){return $(this).attr("data-hovercolor");}
		});
	}, function(){
		$(this).removeAttr("style");
		$(this).css({
			"background-color": function(){return $(this).attr("data-bg");},
			"color": function(){return $(this).attr("data-color");}
		});
	});	
