...
var responsiveNav = (function (window, document) {
  ...
  ResponsiveNav.prototype = {
    ...
    _createStyles: function () {
        style = head.appendChild(styleElement);
        style.id = "responsive-nav-dynamic-css";
    },
    ...
    _transitions: function () {
      if (opts.animate) {
        var objStyle = nav.style,
          transition = "width " + opts.transition + "ms";
    ...
    _calculate: function (window) {
      var savedWidth = nav.offsetWidth,
        innerStyles = "#" + this.wrapperEl + ".opened{width:" + savedWidth + "px; height:" + viewportH + "px; top:"+ window.pageYOffset + "px}";
...
var viewportH = (function (win, docElem) {
...
var viewportW = (function (win, docElem) {
    var mM = win['matchMedia'] || win['msMatchMedia']
...
jQuery(document).ready(function($){
	...
	$(nav).supersubs({
		...
		delay: 0, speed: 'fast', autoArrows:false});
