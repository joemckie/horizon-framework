...
this._createToggle();j(g,"load",this,!1);j(g,"resize",this,!1);j(e,"mousedown",this,!1);j(e,"touchstart",this,!1);j(e,"touchend",this,!1);j(e,"keyup",this,!1);j(e,"click",this,!1)},_removeStyles:function(){m.parentNode&&m.parentNode.removeChild(m)},_createToggle:function(){if(f.customToggle){var a=f.customToggle.replace("#","");if(h.getElementById(a))e=h.getElementById(a);else throw Error("The custom nav toggle you are trying to select doesn't exist");
...
jQuery(document).ready(function($){
	var navigation = responsiveNav("#responsive-nav", {
		...
		open: function() {
			...
			$(".body-wrap").css( "left", "150px" );
			$(".body-wrap").css( "position", "relative" );
		},
		close: function() {
			$("header").css( "left", "0" );
			$(".body-wrap").css( "left", "0px" );
			$(".body-wrap").css( "position", "relative" );
		}
	});
});