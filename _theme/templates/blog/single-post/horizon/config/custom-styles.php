<?php
	...
	} else if(get_option( THEME_SHORT_NAME. '_options_blog_horizon_single_link_thumb_bg_type', 'Pattern' ) == "Pattern" ) {
	...
	} else if(get_option( THEME_SHORT_NAME. '_options_blog_horizon_single_link_thumb_bg_type', 'Pattern' ) == "Custom Image" ) {
	...
	} else if(get_option( THEME_SHORT_NAME. '_options_blog_horizon_single_quote_thumb_bg_type', 'Pattern' ) == "Pattern" ) {
	...
	} else if(get_option( THEME_SHORT_NAME. '_options_blog_horizon_single_quote_thumb_bg_type', 'Pattern' ) == "Custom Image" ) {
