...
<div class="clearfix pagination">
	<div class="left"><?php if($next_link!=="#") { echo '<a class="next_pagination" href="'.$next_link.'">&raquo;</a>'; } ?></div>
	<div class="right"><?php if($prev_link!=="#") { echo '<a class="prev_pagination" href="'.$prev_link.'">&laquo;</a>'; } ?></div>
</div>