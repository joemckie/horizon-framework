...
function horizon_sort_options( $option ) {
	switch ( $option['type'] ):
		case "select":
			return horizon_display_option_select( $option );
			break;
		case "input":
			return horizon_display_option_input( $option );
			break;
		case "textarea":
			return horizon_display_option_textarea( $option );
			break;
		case "checktoggle":
			return horizon_display_option_checktoggle( $option );
			break;
		case "upload":
			return horizon_display_option_file_upload( $option );
			break;
		case "colourpicker":
			return horizon_display_option_colourpicker( $option );
			break;
		case "typography":
			return horizon_display_option_typography( $option );
			break;
		case "text":
			return display_option_text( $option );
			break;
		case "add_sidebar":
			return horizon_display_option_add_sidebar( $option );
			break;
		case "radio-image":
			return horizon_display_option_radio_image( $option );
			break;
		case "open":
			return horizon_display_div_open( $option );
			break;
		case "close":
			return horizon_display_div_close( $option );
			break;
	endswitch;
