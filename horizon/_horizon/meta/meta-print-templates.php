...
function horizon_sort_meta_boxes( $meta_box, $type = NULL ) {
	...
	if ( $type == "sub_item" ) {
		switch ( $meta_box['type'] ):
			case "textarea" :
				return horizon_display_sub_textarea( $meta_box );
				break;
			case "input" :
				return horizon_display_sub_input( $meta_box );
				break;
			case "select" :
				return horizon_display_sub_select( $meta_box );
				break;
			case "checktoggle" :
				return horizon_display_sub_checktoggle( $meta_box );
				break;
		endswitch;
	} else {
		switch ( $meta_box['type'] ):
			case "textarea" :
				return horizon_display_meta_textarea( $meta_box );
				break;
			case "select" :
				return horizon_display_meta_select( $meta_box );
				break;
			case "icon-font-awesome" :
				return horizon_display_meta_icon_select( $meta_box );
				break;
			case "input" :
				return horizon_display_meta_input( $meta_box );
				break;
			case "open" :
				return horizon_display_div_open( $meta_box );
				break;
			case "close" :
				return horizon_display_div_close( $meta_box );
				break;
			case "description" :
				return horizon_display_description( $meta_box );
				break;
			case "mediagallery" :
				return horizon_display_media_gallery( $meta_box );
				break;
			case "checktoggle" :
				return horizon_display_checktoggle( $meta_box );
				break;
			case "radio-image":
				return horizon_display_meta_radio_image( $meta_box );
				break;
			case "colourpicker":
...
function horizon_display_div_close( $a ) {
	return '</div>';
}
