...
<?php
if ( $options['default_search_content_display'] == "content" ) {
...
if ( $options['default_search_term_highlight'] == "highlight" ) {
	...
	if ( $options['default_search_term_highlight'] == "bold" ) {
...
if ( $content == "" ) {
	echo '<p>Sorry, no ' . $options['default_search_content_display'] . ' is available for this post.</p>';
} else {
	echo $content;
}
?>