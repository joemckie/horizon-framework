...
get_header();
do_action( 'horizon_before_index' );
get_template_part( TEMPLATE_PATH . '/titles/index' );
?>

	<div id="main_page_container" class="container">

		<div class="row mb0">
			<!-- START CONTENT -->
			<div id="post-<?php the_ID(); ?>" <?php post_class( 'content ' . horizon_sidebar_layout( false ) ); ?>>
				<div class="row">
					<?php do_action( 'horizon_index' ); ?>
				</div>
			</div>
		</div>
	</div>
