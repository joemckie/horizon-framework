...
get_header();
do_action( 'horizon_before_post' );
get_template_part( TEMPLATE_PATH . '/titles/blog' );
?>
	...
	<div class="container">
		<div class="row">
			<!-- START CONTENT -->
			<div
				id="post-<?php the_ID(); ?>" <?php post_class( 'content clearfix ' . horizon_sidebar_layout( false ) ); ?>>
				<?php do_action( 'horizon_post' ); ?>
			</div>
		</div>
	</div><!-- end container -->
<?php
do_action( 'horizon_after_post' );
get_footer();
?>